...
Veto is listed on Smithery as **`jigyasudham123/veto`** (https://smithery.ai/servers/jigyasudham123/veto).
...
smithery mcp publish .\veto-<version>.mcpb -n jigyasudham123/veto
```

Auth: `smithery auth whoami` / `smithery auth login` (browser OAuth). Namespace is `jigyasudham123`.
