...
export const TOOL_DEFINITIONS = [
  ...
  // ── Council ──────────────────────────────────────────────────────────────────
  {
    ...
    description:
      'Runs the Veto Council — 7 specialist agents (Lead Dev, PM, Architect, UX, Devil\'s Advocate, Legal, Security) debate your task and return a GREEN / YELLOW / RED / DEADLOCK verdict before any code is written. Use strictness to control depth: fast (3 agents), standard (7, default), strict (7 + rebuttal round).',
    inputSchema: {
      type: 'object',
      properties: {
        task: {
