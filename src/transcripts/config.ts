...
export function consentText(dir: string, retentionDays: number): string {
  return [
    ...
    '',
    '  • WHAT: when you save a session, Veto archives your host CLI\'s full local',
    '    conversation transcript (your messages, the AI\'s replies, tool activity)',
    '    and builds a searchable index so a future session can recall exact detail.',
