...
const TAGLINE = '90 agentic tools. 49 specialists. Every major AI CLI. Self-learning. Zero extra cost on subscriptions.';
...
Veto is active. 90 tools across 6 categories:
...
function shortHelpCommand() {
  console.log('');
  console.log(c.bold(c.cyan('  veto')) + c.dim(` v${VERSION}`) + c.dim(` — 90 agentic tools. 49 specialists. Every major AI CLI. Zero extra cost on subscriptions.`));
  console.log('');
  ...
  console.log('');
  console.log(c.bold('  MCP Tools (90 Agentic Tools)'));
  console.log(c.dim('  ─────────────────────────────────────────────────────'));
